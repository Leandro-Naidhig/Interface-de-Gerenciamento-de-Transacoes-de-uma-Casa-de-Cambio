...
<body>
  ...
  <main role="main">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4">
          <center><img src="Imagens/moedas.jpg" class="img-fluid" alt="Imagem responsiva" style="max-width: 50%"></center>
          ...
          <p class="text-center"><a class="btn btn-warning" href="../cliente/moedas.php" role="button">Ver detalhes &raquo;</a></p>
        </div>
        <div class="col-md-4">
          <center><img src="Imagens/pagamento.jpg" class="img-fluid" alt="Imagem responsiva" style="max-width: 50%"></center>
          ...
          <p class="text-center"><a class="btn btn-warning" href="../cliente/informacoes.php" role="button">Ver detalhes &raquo;</a></p>
        </div>
        <div class="col-md-4">
          <center><img src="Imagens/central.png" class="img-fluid" alt="Imagem responsiva" style="max-width: 50%"></center>
          ...
          <p class="text-center">Nosso sistema conta uma central de usuário contendo todas as operações realizadas no site como: status de pedidos de compra ou venda de moedas, histórico de suas transações até o momento, dados pessoais, entre outras
            informações.</p>
          <p class="text-center"><a class="btn btn-warning" href="../cliente/Central_1.html" role="button">Acessar Central de Usuário &raquo;</a></p>
        </div>
      </div>
    </div> <!-- /container -->
