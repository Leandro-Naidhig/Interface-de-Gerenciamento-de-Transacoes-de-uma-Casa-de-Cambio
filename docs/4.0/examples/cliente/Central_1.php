<?php
    ...
    $sql = "SELECT compra.valor AS valor, compra.entrega AS entrega, compra.forma_pgmto AS pagamento, compra.date AS data, compra.status AS status, moeda.nome AS nome FROM `compra` INNER JOIN `moeda` ON (compra.moeda_usada_fk = moeda.moeda_id AND compra.moeda_comprada_fk = moeda.moeda_id) WHERE `cpf_fk` = '".$_SESSION['usuario_cpf']."' ORDER BY date";
  ...
  <main role="main">
    ...
    <div class="jumbotron">
      <div class="container text-white">
        ...
        <p class="text-center">"Encontre todas as suas informações referentes a informações pessoais, histórico de compras, "</p>
      </div>
    </div>
              ...
              <div class="col-md-6">
                <div class="card flex-md-row mb-4 shadow-sm h-md-250">
                  <div class="card-body d-flex flex-column align-items-start">
                    <strong class="d-inline-block mb-2 text-primary">Real -> Dólar</strong>
                    <h6 class="mb-0">
                      <a class="text-dark" href="#"><?php echo $obj->valor;?> dólares</a>
                    </h6>
                    <div class="mb-1 text-muted small"><?php echo $obj->date;?></div>
                    <p class="card-text mb-auto">Método de pagamento: <?php echo $obj->forma_pgmto;?></p>
                  </div>
                </div>
              </div>
            <?php
