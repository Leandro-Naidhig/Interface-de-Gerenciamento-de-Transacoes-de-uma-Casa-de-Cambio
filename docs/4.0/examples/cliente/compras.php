          ...
          <form>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="text" style="font-weight:normal!important;" class="form-control" id="input_end"  value="<?php echo $search_value_bairro; ?>"  required autofocus />
    ...
    $(document).ready(function() {
      ...
      $("#smartwizard").on("leaveStep", function(e, anchorObject, stepNumber, stepDirection) {
        ...
        if (stepDirection === 'forward' && elmForm) {
          ...
          if ((endereco.val() == "" || cidade.val() == "" || estado.val() == "") && stepNumber == 2) {
